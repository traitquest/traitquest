...
<body>
	...
	<div class="col-lg-10 col-lg-offset-2 col-md-10 col-md-offset-2 col-sm-12 col-xs-12 grey95-bg padding-bottom-s"><!content goes here>
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-topbottom-s padding-leftright-s padding-bottom-s border-top-grey white-bg"><!1stwindow>
			...
			<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 margin-topbottom-xs padding-leftright-s padding-bottom-s">
				<p> Current Objective</p>
			</div>
			<textarea type="text" name="objective" id="objective" class="col-lg-4 col-md-4 col-sm-12 col-xs-12 margin-topbottom-xs padding-bottom-s" placeholder="Edit Objective" rows="4"></textarea>
			<div class="col-lg-4 col-md-4 col-lg-offset-1 col-md-offset-1 col-sm-12 col-xs-12 margin-topbottom-xs padding-leftright-s padding-bottom-s">
				...
				<input type="submit" name="submit" id="editKRACancel" class="buttonForm buttonCancel clear-both display-block display-inline margin-top-xs" value="Cancel" />
			</div>
